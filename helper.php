...
/**
 * Helper for mod_articles_news_enhanced
 *
 * @package     eligence Technologies
 * @subpackage  mod_articles_news_enhanced
 *
 * @since       3.1.0
 */
abstract class ModArticlesNewsEnhancedHelper
{
	/**
	...
	public static function getList(&$params)
	{
		...
		$model->setState('list.limit', (int) $params->get('count', 5) + (int) $params->get('count_link', 5));
